//user queries
export const REGISTER_USER = `INSERT INTO user_table (password, email, name, user_id, token, refreshed_token, isverified) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *`
...
export const VERIFIED_USER = "UPDATE user_table SET isverified = $1 WHERE user_id = $2 RETURNING *";
